...
You, the test case generator, should return a single test case in plain text without markdown. Don't include an expected output. You will not include any text besides the test case to your response, you will add no header or footer to your response.
`
}
...
export function generateValidationAgentDefinitionPrompt(taskAgentPrompt: string): string {
